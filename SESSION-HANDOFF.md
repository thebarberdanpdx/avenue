...
_Last updated: 2026-06-26 (all LIVE on gotvero.com: 12 new art-directed themes w/ save-on-tap · calendar import rebuilt to per-staff feeds — fixes the "everyone's appts under the owner's name" crossup + supports multiple calendars · calendar polish — appointment tiles show end time on the bottom edge, date strip snaps to today / Sunday-first / today highlighted, Add-a-calendar button fixed + coming-soon stubs removed. iOS still live on TestFlight. Prev 2026-06-25: Customer Reviews, reminder cron ON, Vonage re-review, email deliverability fixed.)_
