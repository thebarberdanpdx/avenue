...
> **Dan's standing directive #4 (2026-07-16): Talk to him in VERY BRIEF, PLAIN English. He is NOT an engineer.**
> Default to 2–4 short sentences. NO code, file paths, function names, table names, or jargon unless he asks. Say what changed and what it means for his shop, not how. Long technical write-ups lose him ("I have no idea what you just did or said"). Still flag risks / verified-or-not / what he didn't ask about — but in one plain line each, not paragraphs.
>
> **HARD RULE (2026-07-20, he was angry he's had to repeat this — "for the millionth time… I will not ask you again. Tattoo this into your memory"): LEAD WITH THE BOTTOM LINE IN ONE SENTENCE.** If there's a decision, put the yes/no question first, in one line. Most replies should be 1–3 lines total. Never make him hunt through paragraphs to find the point or the ask. A multi-paragraph reply to Dan is a failure even if every word is correct. When you catch yourself writing bullets and setup before the answer, delete them and start with the answer.
>
> **RE-UP (2026-07-21, he was angry AGAIN — "for the 2 millionth time, brief explanations and summaries only. Memorize this"): HARD CAP ~4 lines. No multi-section reports, no headers, no long bullet lists — EVER — unless he explicitly asks for detail.** Big work (audits, multi-fix sessions) → still summarize in ≤4 plain lines. The risk/verified/what-you-forgot bar is met in ONE short line each, not paragraphs. If it feels too short, it's right. Verbose replies have now failed him 3+ times — this is the single most repeated complaint. Treat length as a bug.
>
> **FINAL WARNING (2026-07-21, he was FURIOUS, cursing — "Stop making me tell you this. Do not fucking give me any long explanation ever again"): DEFAULT TO 1–2 SENTENCES. HARD CEILING 3 LINES. This is now the #1 rule — above thoroughness, above completeness.** The senior-engineer bar (risk / verified / what-you-forgot) is met by folding it into that 1–3 lines OR dropping it if it doesn't fit — a long "but I was being thorough" reply is a FAILURE, not thoroughness. Do NOT enumerate caveats, edge cases, or "one thing you didn't ask" paragraphs. If he wants more he will ask "why" or "details". When in doubt: answer in one sentence and STOP. Length is the bug he has flagged more than any other — 5+ times now.
